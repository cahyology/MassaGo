...
VALUES
('SRV-TRAD', 'Pijat Tradisional Jawa', 'Tradisional', 'Pijatan urut seluruh tubuh dengan teknik tradisional warisan leluhur.', 'Pijatan menyeluruh untuk melancarkan sirkulasi darah dan melepas otot kaku.', ARRAY['Melancarkan peredaran darah', 'Meredakan pegal linu', 'Membantu tidur nyenyak'], 120000, 160000, 210000, '💆‍♂️', 0),
('SRV-REFL', 'Refleksi Kaki & Akupresur', 'Refleksi', 'Titik akupresur telapak kaki dan tangan untuk memulihkan vitalitas.', 'Terapi saraf titik refleksi organ tubuh untuk melancarkan metabolisme tubuh.', ARRAY['Meredakan ketegangan kaki', 'Melancarkan metabolisme', 'Mencegah kram'], 110000, 150000, 190000, '🦶', 0),
('SRV-DEEP', 'Deep Tissue & Sport Massage', 'Kebugaran', 'Tekanan intensif untuk simpul otot kaku setelah olahraga berat.', 'Teknik pijat lapisan jaringan otot dalam untuk mengurai asam laktat.', ARRAY['Memecah simpul otot kaku', 'Mempercepat pemulihan', 'Meningkatkan kelenturan'], 150000, 210000, 260000, '💪', 0),
('SRV-SCRUB', 'Lulur & Body Scrub Spa', 'Spa & Kulit', 'Pijat relaksasi dipadu scrub rempah organik untuk kulit cerah & halus.', 'Perawatan spa menyeluruh diawali pijatan lembut dan lulur rempah bengkoang/kopi.', ARRAY['Mengangkat sel kulit mati', 'Mencerahkan & melembutkan', 'Sensasi spa di rumah'], 0, 200000, 245000, '✨', 0),
('SRV-BEKAM', 'Bekam & Kerokan Higienis', 'Kesehatan', 'Pelepas masuk angin dan letih dengan peralatan steril higienis.', 'Terapi kerokan halus atau bekam kering dengan alat steril 1x pakai.', ARRAY['Meredakan masuk angin', 'Melonggarkan pernapasan', 'Peralatan 100% steril'], 135000, 185000, 0, '🍃', 0),
('SRV-PRENATAL', 'Pijat Relaksasi Ibu Hamil', 'Khusus', 'Pijatan lembut khusus ibu hamil oleh terapis bersertifikasi resmi prenatal.', 'Posisi menyamping yang aman dan nyaman untuk meredakan nyeri pinggang & pegal kaki.', ARRAY['Certified Prenatal Therapist', 'Meredakan nyeri panggul', 'Menenangkan calon ibu'], 175000, 230000, 0, '🤰', 0)
