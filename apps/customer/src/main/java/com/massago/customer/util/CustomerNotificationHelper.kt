package com.massago.customer.util
...
import com.massago.customer.MainActivity

object CustomerNotificationHelper {

    private const val TRACKING_CHANNEL_ID = "massago_customer_tracking"
    private const val CHAT_CHANNEL_ID = "massago_customer_chat"
