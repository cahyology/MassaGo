package com.pijatin.customer.data.network
        ...
        try {
            ...
            val payload = JsonObject().apply {
                add("order", JsonObject().apply {
                    ...
                    addProperty("callback_url", "https://pijatin.com/api/doku/notify")
                ...
                add("customer", JsonObject().apply {
                    ...
                    addProperty("name", customerName.ifBlank { "Pelanggan PijatIn" })
        ...
        try {
            ...
            val payload = JsonObject().apply {
                ...
                add("customer_details", JsonObject().apply {
                    addProperty("first_name", customerName.ifBlank { "Pelanggan PijatIn" })
                    addProperty("phone", customerPhone.ifBlank { "+6289680078070" })
                })
                add("callbacks", JsonObject().apply {
                    addProperty("finish", "pijatin://payment-finish")
                })
            }
                    ...
                    <body>
                        ...
                        <script>
                            ...
                            function simulateSuccess() {
                                ...
                                setTimeout(function() {
                                    window.location.href = 'pijatin://payment-finish?order_id=$orderId&status_code=200&transaction_status=settlement';
                                }, 500);
                            }
                        </script>
                    </body>
