...
// Canonical Standard Service Catalog (Single Valid Service)
export const CANONICAL_SERVICE_PACKAGES: ServicePackage[] = [
  {
    ...
    short_description: 'Pijat tradisional seluruh tubuh untuk meredakan pegal linu, melancarkan sirkulasi darah, dan memulihkan kebugaran tubuh secara profesional.',
    full_description: 'Layanan pemijatan keluarga profesional langsung ke lokasi Anda. Menggabungkan teknik kombinasi urut tradisional, peregangan relaksasi, dan penekanan titik simpul otot kaku dengan minyak aromaterapi alami berkualitas tinggi.',
    benefits: [
