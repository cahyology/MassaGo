package com.pijatin.mitra.service
...
class MitraLocationService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "pijatin_mitra_location_channel"
        ...
        locationCallback = object : LocationCallback() {
            override fun onLocationResult(result: LocationResult) {
                ...
                if (location != null) {
                    ...
                    if (currentProfile.dutyStatus == com.pijatin.mitra.data.model.DutyStatus.OFFLINE || !currentProfile.isVerified) {
                        stopSelf()
                        return
                    }
                    ...
                    serviceScope.launch {
                        ...
                        val activeOrder = com.pijatin.mitra.data.repository.OrderRepository.instance.activeOrder.value
                        if (activeOrder != null && activeOrder.status == com.pijatin.mitra.data.model.OrderStatus.ACCEPTED_ON_THE_WAY) {
    ...
    private fun buildForegroundNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("PijatIn Mitra — Siap Terima Pesanan")
