...
fun TopUpDepositDialog(
    ...
    if (activePaymentUrl != null) {
        com.pijatin.mitra.ui.components.PaymentWebViewDialog(
                ...
                Button(
                    onClick = {
                        try {
                            ...
                            val msg = "Halo Admin PijatIn, saya Mitra PijatIn ingin konfirmasi transfer top-up saldo deposit sebesar Rp ${currencyFormat.format(selectedAmount)}."
