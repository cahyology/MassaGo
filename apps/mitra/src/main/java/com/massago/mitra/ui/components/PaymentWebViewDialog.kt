                    ...
                    Row(
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            ...
                            Column {
                                ...
                                Text(
                                    text = "DOKU Official Checkout • SSL 256-bit",
                            ...
                            WebView(ctx).apply {
                                ...
                                webViewClient = object : WebViewClient() {
                                    ...
                                    override fun shouldOverrideUrlLoading(view: WebView?, request: WebResourceRequest?): Boolean {
                                        ...
                                        if (url.contains("/api/doku/notify") || url.contains("status=success") || url.contains("massago://success")) {
                                            onPaymentSuccess()
                                            onDismiss()
                                            return true
                                        }
